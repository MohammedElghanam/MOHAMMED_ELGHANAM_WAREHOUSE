...
//           console.log('Barcode from params:', barcode);
...
const ProductDetailsPage = () => {
    interface Product {
      ...
      const handleReapprovisionner = () => {
        ...
        console.log('Réapprovisionner clicked');
      };

      const handleDecharger = () => {
        // Logic to decrease quantity
        console.log('Décharger clicked');
      };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.button} onPress={handleReapprovisionner}>
          <Text style={styles.buttonText}>Réapprovisionner</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={handleDecharger}>
