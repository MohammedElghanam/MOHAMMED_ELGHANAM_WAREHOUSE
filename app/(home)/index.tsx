  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        columnWrapperStyle={styles.row} // تنسيق الصفوف
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 10,
    backgroundColor: '#f5f5f5', // لون خلفية الصفحة
  },
  searchBar: {
    marginBottom: 10,
    padding: 10,
  ...
  row: {
    justifyContent: 'space-between', // توزيع العناصر في الصف
  },
  productCard: {
    width: (width / 2) - 15, // عرض العنصر (منتجين في الصف مع تباعد)
    marginBottom: 15,
    backgroundColor: '#fff',
    borderRadius: 10,
    shadowColor: '#000',
